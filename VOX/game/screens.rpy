...
init:
    transform trans30:
        alpha 0.3
    image main_menu_cg="gui/main_menu_cg.jpg"
    image main_menu_cg_foggy=LiveComposite((1366,768), (0,0), Solid("#fff"), (0,0), At("gui/main_menu_cg.jpg", trans30))
...
screen main_menu:
    ...
    $ y=110
    imagebutton auto "gui/main_start_%s.png" xpos 1022 ypos y focus_mask True action Start() hovered [ Play ("test_one", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_main_menu_start") ] unhovered [Hide("gui_tooltip")] at main_eff1    
    $ y+=90
    imagebutton auto "gui/main_load_%s.png" xpos 1022 ypos y focus_mask True  action ShowMenu('load') hovered [ Play ("test_two", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_load") ] unhovered [Hide("gui_tooltip")] at main_eff2
    $ y+=90
    imagebutton auto "gui/main_config_%s.png" xpos 1022 ypos y focus_mask True action ShowMenu('preferences') hovered [ Play ("test_three", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_config") ] unhovered [Hide("gui_tooltip")] at main_eff3
    $ y+=90
    ...
    imagebutton auto "gui/main_extras_%s.png" xpos 1022 ypos y focus_mask True action ShowMenu('extras_blank') hovered [ Play ("test_four", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_main_menu_extras") ] unhovered [Hide("gui_tooltip")] at main_eff4
    $ y+=90
    
    imagebutton auto "gui/main_help_%s.png" xpos 1022 ypos y focus_mask True action ShowMenu('help') hovered [ Play ("test_five", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_main_menu_help") ] unhovered [Hide("gui_tooltip")] at main_eff4
    $ y+=90
    
    imagebutton auto "gui/main_quit_%s.png" xpos 1022 ypos y focus_mask True action Quit(confirm=False) hovered [ Play ("test_six", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_quit") ] unhovered [Hide("gui_tooltip")] at main_eff5
...
screen navigation:
    ...
    imagebutton auto "gui/game_menu_save_%s.png" xpos 1060 ypos 129 focus_mask True action ShowMenu('save') hovered [ Play ("test_one", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_save") ] unhovered [Hide("gui_tooltip")] at nav_eff
    imagebutton auto "gui/game_menu_load_%s.png" xpos 1060 ypos 214 focus_mask True action ShowMenu('load') hovered [ Play ("test_two", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_load") ] unhovered [Hide("gui_tooltip")] at nav_eff
    imagebutton auto "gui/game_menu_config_%s.png" xpos 1060 ypos 297 focus_mask True action ShowMenu('preferences') hovered [ Play ("test_three", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_config") ] unhovered [Hide("gui_tooltip")] at nav_eff
    imagebutton auto "gui/game_menu_main_menu_%s.png" xpos 1060 ypos 381 focus_mask True action MainMenu() hovered [ Play ("test_one", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_main") ] unhovered [Hide("gui_tooltip")] at nav_eff
    imagebutton auto "gui/game_menu_return_%s.png" xpos 1060 ypos 465 focus_mask True action Return() hovered [ Play ("test_two", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_return") ] unhovered [Hide("gui_tooltip")] at nav_eff
    imagebutton auto "gui/game_menu_quit_%s.png" xpos 1060 ypos 549 focus_mask True action Quit() hovered [ Play ("test_three", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_game_menu_quit") ] unhovered [Hide("gui_tooltip")] at nav_eff
...
init -2:
    transform nav_eff:
        on idle:
            easein 0.5 xpos 1060
        on selected_idle:
            easein 0.5 xpos 1060
        on hover:
            easein 0.3 xpos 1080
            easein 0.3 xpos 1040
        on selected_hover:
            easein 0.3 xpos 1080
            easein 0.3 xpos 1040
...
screen preferences:
    ...
    imagebutton auto "gui/config_display_window_%s.png" xpos 395 ypos 236 focus_mask True action Preference('display', 'window') at config_eff hovered [ Play ("test_one", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_windowed") ] unhovered [Hide("gui_tooltip")]
    imagebutton auto "gui/config_display_fullscreen_%s.png" xpos 513 ypos 236 focus_mask True action Preference('display', 'fullscreen') at config_eff hovered [ Play ("test_two", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_fullscreen") ] unhovered [Hide("gui_tooltip")]
    # Transitions on/off:
    imagebutton auto "gui/config_transitions_none_%s.png" xpos 664 ypos 236 focus_mask True action Preference('transitions', 'none') at config_eff hovered [ Play ("test_four", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_enable_transition") ] unhovered [Hide("gui_tooltip")]
    imagebutton auto "gui/config_transitions_all_%s.png" xpos 783 ypos 236 focus_mask True action Preference('transitions', 'all') at config_eff hovered [ Play ("test_four", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_enable_transition") ] unhovered [Hide("gui_tooltip")]
    # Stop/continue skipping after choices
    imagebutton auto "gui/config_afterchoices_stop_%s.png" xpos 395 ypos 452 focus_mask True action Preference('after choices', 'stop') at config_eff hovered [ Play ("test_one", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_stop_skip") ] unhovered [Hide("gui_tooltip")]
    imagebutton auto "gui/config_afterchoices_skip_%s.png" xpos 513 ypos 452 focus_mask True action Preference('after choices', 'skip') at config_eff hovered [ Play ("test_two", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_go_skip") ] unhovered [Hide("gui_tooltip")]
    # Skip all/seen text
    imagebutton auto "gui/config_skip_seen_%s.png" xpos 664 ypos 452 focus_mask True action Preference('skip', 'seen') at config_eff hovered [ Play ("test_one", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_seen") ] unhovered [Hide("gui_tooltip")]
    imagebutton auto "gui/config_skip_all_%s.png" xpos 783 ypos 452 focus_mask True action Preference('skip', 'all') at config_eff hovered [ Play ("test_two", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_all") ] unhovered [Hide("gui_tooltip")]
    ...
    imagebutton auto "gui/config_begin_skipping_%s.png" xpos 408 ypos 141 focus_mask True action Preference('begin skipping') hovered [ Play ("test_one", "sfx/click.wav"), Show("gui_tooltip", my_picture="tooltip_config_skipping") ] unhovered [Hide("gui_tooltip")]
    # bar sliders for volume control, text speed and auto-forward time
    frame xpos 80 ypos 200:
        style_group "pref"
        has vbox
        bar value Preference("music volume")
    frame xpos 80 ypos 320:
        style_group "pref"
        has vbox
        bar value Preference("sound volume")
    frame xpos 80 ypos 440:
        style_group "pref"
        has vbox
        bar value Preference("text speed")
    frame xpos 80 ypos 540:
        style_group "pref"
        has vbox
...
init:
    ...
    image enemy1 future = "crawler/enemy1_future.png"
    image enemy1 past = "crawler/enemy1_past.png"
    image enemy1 present = "crawler/enemy1_present.png"
    image enemy1 space = "crawler/enemy1_space.png"

    image enemy2 future = "crawler/enemy2_future.png"
    image enemy2 past = "crawler/enemy2_past.png"
    image enemy2 present = "crawler/enemy2_present.png"
    image enemy2 space = "crawler/enemy2_space.png"

    image enemy3 future = "crawler/enemy3_future.png"
    image enemy3 past = "crawler/enemy3_past.png"
    image enemy3 present = "crawler/enemy3_present.png"
    image enemy3 space = "crawler/enemy3_space.png"

    image enemy4 future = "crawler/enemy4_future.png"
    image enemy4 past = "crawler/enemy4_past.png"
    image enemy4 present = "crawler/enemy4_present.png"
    image enemy4 space = "crawler/enemy4_space.png"

    image enemyb1 future = "crawler/enemyb1_future.png"
    image enemyb2 future = "crawler/enemyb2_future.png"
    image enemyb1 past = "crawler/enemyb1_past.png"
    image enemyb2 past = "crawler/enemyb2_past.png"
    image enemyb1 present = "crawler/enemyb1_present.png"
    image enemyb2 present = "crawler/enemyb2_present.png"
    image enemyb1 space = "crawler/enemyb1_space.png"
    image enemyb2 space = "crawler/enemyb2_space.png"
...
init:
    ...
    image tooltip_inventory_muskete=LiveComposite((665, 73), (3,0), ImageReference("information"), (3,30), Text("An energy gun that resembles an old muskete from days\nlong gone. Most effective on enemies from the Past.", style="tips_bottom"))
...
screen help2:
    ...
    textbutton "Next Page" xpos 50 ypos .75 action ShowMenu('help3')
...
screen help3:
    ...
    frame background None xpos 50 ypos 80 xmaximum 900:
        style_group "help"
        has vbox spacing 20
        text "Combat mode - Seconds:" size 40
        text "{b}Defend:{/b} Reduces the damage taken by 50% for the next move."        
        text "{b}Bite{/b} Damages the enemy for [Punch.power]HP. [Punch.hit]% accuracy."
        text "{b}Scratch:{/b} Damages the enemy for [Scratch.power]HP. [Scratch.hit]% accuracy."
        text "{b}Charge:{/b} Damages the enemy for [Charge.power]HP. [Charge.hit]% accuracy."
        text "Note: The values may be lowered, if Seconds is weakened!"
    textbutton "First Page" xpos 50 ypos .75  action ShowMenu('help')
